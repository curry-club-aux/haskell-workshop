...
\begin{aufgabe}{Groß- und Kleinschreibung}
  \begin{enumerate}
    ...
    {\scriptsize \emph{Hinweis.} Verwende \haskellinline[fontsize=\scriptsize]{and :: [Bool] -> Bool} und \haskellinline[fontsize=\scriptsize]{isLower :: Char -> Bool} aus \textinline[fontsize=\scriptsize]{Data.Char}.\par}
